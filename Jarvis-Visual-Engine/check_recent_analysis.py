...
try:
    ...
    with db.session() as session:
        recent = AnalysisQueries.get_recent_analysis(session, hours=1, limit=5)
        ...
        if not recent:
            ...
            for i, a in enumerate(recent, 1):
                ...
                if a.analysis_text:
                    analysis_preview = a.analysis_text[:200] if len(a.analysis_text) > 200 else a.analysis_text

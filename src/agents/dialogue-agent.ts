...
/**
 * Owns Jarvis's primary conversational response loop.
 *
 * The Dialogue agent decides when a prompt can be answered directly, when it
 * should be enriched with live Web-agent context, and how the final assistant
 * response should be cleaned before it is returned to the user.
 *
 * @agent DialogueAgent
 * @domain agents.dialogue
 * @critical
 */
